...
public class HKClassloader extends ClassLoader {
	 
    /**
     * This constructor is used to set the parent ClassLoader
     */
    public HKClassloader(ClassLoader parent) {
        super(parent);
    }
    ...
    public Class loadClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("jvmInternals")) {
            System.out.println("Loading Class using " + getClass().getName()+ "-----------" + getClass().getClassLoader());
